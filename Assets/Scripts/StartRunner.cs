...
public class StartRunner : MonoBehaviour
{
    ...
    {
        float counter = 0;
        while (Mathf.Abs(player.transform.parent.transform.position.x) > 0 || Mathf.Abs(player.transform.localPosition.x) > 0 || counter < 0.5f)
        {
            ...
            player.transform.parent.transform.position = Vector3.MoveTowards(player.transform.parent.transform.position, new Vector3(0, player.transform.parent.transform.position.y, player.transform.parent.transform.position.z), 4 * Time.deltaTime);
            player.transform.localPosition = Vector3.MoveTowards(player.transform.localPosition, new Vector3(0, player.transform.localPosition.y, player.transform.localPosition.z), 4 * Time.deltaTime);
